          ...
          <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-6">
              <div id="logo">
                ...
                <img src="assets/images/services/logo.png" width = "80px", height = "80px" ></a>
              </div> <!-- /.logo -->
            </div> <!-- /.col-md-4 -->
...
object header extends header_Scope0.header
              /*
                  -- GENERATED --
                  DATE: Tue Jul 05 18:13:22 NPT 2016
                  SOURCE: /home/rajan/web-master/app/views/header.scala.html
                  HASH: f07da67206114ce4484e8cf79589a587bdb69211
